...
#optional
parser.add_argument('-term', dest='knownTerminators', help='input known Terminators')
...
if 'EF' in positivesFile:
	organism = 'E.faecalis'
	organismBrev = 'EF'
	if 'Chromosome' in positivesFile:
		chrom = "NC_004668.1"
		chrom2 = chrom
	if 'Plasmid1' in positivesFile:
		chrom = "NC_004669.1"
		chrom2 = chrom
	if 'Plasmid2' in positivesFile:
		chrom = "NC_004671.1"
		chrom2 = chrom
	if 'Plasmid3' in positivesFile:
		chrom = "NC_004670.1"
		chrom2 = chrom
