...
# # trimming Illumina adapters with fastp


# fastp -i $pathToParentDirectory"/RNASeq/ERX1320302.fastq" -o $pathToParentDirectory"/RNASeq/trim_ERX1320302.fastq"
# fastp -i $pathToParentDirectory"/TermSeq/ERX1320300.fastq" -o $pathToParentDirectory"/TermSeq/trim_ERX1320300.fastq"
# fastp -i $pathToParentDirectory"/TermSeq/ERX1320301.fastq" -o $pathToParentDirectory"/TermSeq/trim_ERX1320301.fastq"
# fastp -i $pathToParentDirectory"/TermSeq/ERX1304415.fastq" -o $pathToParentDirectory"/TermSeq/trim_ERX1304415.fastq"

# printf "\n##########################################################"
# printf '\n\t\t All adapters trimmed'
# printf "\n##########################################################\n\n"
...
# 			-o SAM > $pathToParentDirectory"/Alignments/knownTerminators.sam"
# printf "\n"

# align Term-Seq and RNA-Seq files to B.subtilis genome with Novoalign
# novoalign -f $pathToParentDirectory"/RNASeq/trim_ERX1320302.fastq" -d $pathToParentDirectory/"Alignments/Bacillus_subtilis_UtoT_index" \
# 			-o SAM > $pathToParentDirectory"/Alignments/RNASeq/trim_ERX1320302.sam"
# printf "\n"
# novoalign -f $pathToParentDirectory"/TermSeq/trim_ERX1304415.fastq" -d $pathToParentDirectory/"Alignments/Bacillus_subtilis_UtoT_index" \
# 			-o SAM > $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1304415.sam"
# printf "\n"
# novoalign -f $pathToParentDirectory"/TermSeq/trim_ERX1320300.fastq" -d $pathToParentDirectory/"Alignments/Bacillus_subtilis_UtoT_index" \
# 			-o SAM > $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1320300.sam"
# printf "\n"
# novoalign -f $pathToParentDirectory"/TermSeq/trim_ERX1320301.fastq" -d $pathToParentDirectory/"Alignments/Bacillus_subtilis_UtoT_index" \
# 			-o SAM > $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1320301.sam"
...
# samtools view -S -b $pathToParentDirectory"/Alignments/knownTerminators.sam" > $pathToParentDirectory/"Alignments/knownTerminators.bam"

# samtools view -S -b $pathToParentDirectory"/Alignments/RNASeq/trim_ERX1320302.sam" > $pathToParentDirectory"/Alignments/RNASeq/trim_ERX1320302.bam"
# samtools view -S -b $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1304415.sam" > $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1304415.bam"
# samtools view -S -b $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1320300.sam" > $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1320300.bam"
# samtools view -S -b $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1320301.sam" > $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1320301.bam"

# sorting and indexing bam files to make them readable for genome browsers (e.g. IGV)
# samtools sort $pathToParentDirectory"/Alignments/RNASeq/trim_ERX1320302.bam" -o $pathToParentDirectory"/Alignments/RNASeq/trim_sorted_ERX1320302.bam" \
# 				> $pathToParentDirectory"/Alignments/RNASeq/trim_sorted_ERX1320302.bam"
# samtools sort $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1304415.bam" -o $pathToParentDirectory"/Alignments/TermSeq/trim_sorted_ERX1304415.bam" \
# 				> $pathToParentDirectory"/Alignments/TermSeq/trim_sorted_ERX1304415.bam"
# samtools sort $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1320300.bam" -o $pathToParentDirectory"/Alignments/TermSeq/trim_sorted_ERX1320300.bam" \
# 				> $pathToParentDirectory"/Alignments/TermSeq/trim_sorted_ERX1320300.bam"
# samtools sort $pathToParentDirectory"/Alignments/TermSeq/trim_ERX1320301.bam" -o $pathToParentDirectory"/Alignments/TermSeq/trim_sorted_ERX1320301.bam" \
# 				> $pathToParentDirectory"/Alignments/TermSeq/trim_sorted_ERX1320301.bam"

# samtools index $pathToParentDirectory"/Alignments/RNASeq/trim_sorted_ERX1320302.bam"
# samtools index $pathToParentDirectory"/Alignments/TermSeq/trim_sorted_ERX1304415.bam"
# samtools index $pathToParentDirectory"/Alignments/TermSeq/trim_sorted_ERX1320300.bam"
# samtools index $pathToParentDirectory"/Alignments/TermSeq/trim_sorted_ERX1320301.bam"
...
# bedtools bamtobed -i $pathToParentDirectory/"Alignments/knownTerminators.bam" \
# 					> $pathToParentDirectory"/Alignments/knownTerminators.bed"

# ###############################################################################################################################################

# # calculate genome coverage of RNA-Seq file with 
# genomeCoverageBed -d -split -ibam $pathToParentDirectory"/Alignments/RNASeq/trim_sorted_ERX1320302.bam" \
# 					> $pathToParentDirectory"/Alignments/RNASeq/trim_sorted_ERX1320302_genomeCoverageBed.bedgraph"
...
# 										-termSeq $pathToParentDirectory"/Alignments/TermSeq/trim_" \
...
python $pathToParentDirectory"/Scripts/ratioTermRNASeq.py" -gff $pathToParentDirectory"/Genomes/GCF_000009045.1_ASM904v1_genomic.gff" \
						-ts $pathToParentDirectory"/Alignments/TermSeq/stop_trim_ERX1320300.bedgraph" \
							$pathToParentDirectory"/Alignments/TermSeq/stop_trim_ERX1320301.bedgraph" \
							$pathToParentDirectory"/Alignments/TermSeq/stop_trim_ERX1304415.bedgraph" \
						-rs $pathToParentDirectory"/Alignments/RNASeq/trim_sorted_ERX1320302_genomeCoverageBed.bedgraph" \
						-bed $pathToParentDirectory"/Alignments/knownTerminators.bed" \
						-g 1 4215606 \
						-o $pathToParentDirectory"/Results/trim_wholeGenome"
...
# python $pathToParentDirectory"/Scripts/classification.py" -pos $pathToParentDirectory"/Results/trim_wholeGenome_50_nucs_TScountsOverlappingTerminators" \
# 						-neg $pathToParentDirectory"/Results/trim_wholeGenome_50_nucs_TScountsOverlappingGenes" \
# 						-all $pathToParentDirectory"/Results/trim_wholeGenome_50_nucs_TSvsRS" \
...
# 						-o $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/trim_"
...
# 		-pos $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/trim_60_predictedTerminators_NO_knownTerminators_NO_genes.bed"\
# 		-neg $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/trim_60_predictedNegatives_NO_knownTerminators_NO_genes.bed"\
# 		-gene $pathToParentDirectory"/Genomes/GCF_000009045.1_ASM904v1_genomic.gff" \
# 		-o $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/Distance/trim_"
...
# 		-bed $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/Distance/trim_Distance_60_predictedTerminators_NO_knownTerminators_NO_genes.bed"\
#  		-name | \
# cat | while read L; do if [[ $L == *+ ]]; then echo $L; read L; echo $L | rev | tr "ATGC" "TACG" ; elif [[ $L == *- ]]; \
# 		then echo $L; read L; echo $L; fi; done > $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/Distance/trim_Distance_60_predictedTerminators_NO_knownTerminators_NO_genes.fasta" 		

# bedtools getfasta -fi $pathToParentDirectory"/Genomes/Bacillus_subtilis_UtoT.fasta" \
# 		-bed $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/Distance/trim_Distance_60_predictedNegatives_NO_knownTerminators_NO_genes.bed"\
#  		-name | \
# cat | while read L; do if [[ $L == *+ ]]; then echo $L; read L; echo $L | rev | tr "ATGC" "TACG" ; elif [[ $L == *- ]]; \
# 		then echo $L; read L; echo $L; fi; done > $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/Distance/trim_Distance_60_predictedNegatives_NO_knownTerminators_NO_genes.fasta" 
...
# blastn -query $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/Distance/trim_Distance_60_predictedTerminators_NO_knownTerminators_NO_genes.fasta" \
# 		-db ~/blastdb/new_known_terminators_db \
# 		-word_size 7 \
# 		-outfmt 6 |
# sort -k12 -rn > $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/BLAST/trim_BLAST_60_predictedTerminators_NO_knownTerminators_NO_genes.tab"
...
# python $pathToParentDirectory"/Scripts/filterBLAST.py" -term  $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/Distance/trim_Distance_60_predictedTerminators_NO_knownTerminators_NO_genes.bed"\
# 		-blast $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/BLAST/trim_BLAST_60_predictedTerminators_NO_knownTerminators_NO_genes.tab"\
# 		-o $pathToParentDirectory"/Results/PredictedPositivesAndNegatives/BLAST/trim_"