...
outfiles = [outpath + brev + '_predTerm_BLAST_predictedTerminators_NO_knownTerminators_NO_genes_long60.bed',
			outpath + brev + '_500front_BLAST_predictedTerminators_NO_knownTerminators_NO_genes_long60.bed',
			outpath + brev + '_500back_BLAST_predictedTerminators_NO_knownTerminators_NO_genes_long60.bed']
