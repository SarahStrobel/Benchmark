        ...
        for i in range(0,(len(linesTS)), numberOfNucsToSplitInto):
                ...
                for i in range(len(linesTS3)):
                        ...
                        if TSstart > numberOfNucsInGenome[0] and TSstart < numberOfNucsInGenome[1]:
                                ...
                                # take floor of the TScount's, for compatibility with Python2 scripts
                                TScount=math.floor(TScount)
                                TScount2=math.floor(TScount2)
                                TScount3=math.floor(TScount3)
                                TScount4=math.floor(TScount4)
                                ...
                                avgTScount = np.mean([TScount, TScount2, TScount3, TScount4])
                                if avgTScount>0:
                                    tsCountRawArray=[linesTS3[i].split()[3],lines2TS3[i].split()[3],lines3TS3[i].split()[3],lines4TS3[i].split()[3]]
                                    #print("data = %s . [%s,%s,%s,%s] -> [%s,%s,%s,%s], %s,%s" % (str(avgTScount),str(tsCountRawArray[0]),str(tsCountRawArray[1]),str(tsCountRawArray[2]),str(tsCountRawArray[3]),str(TScount),str(TScount2),str(TScount3),str(TScount4),str(uniqueReadsTSCombinedBS),str(uniqueReadsTSCombined)))
