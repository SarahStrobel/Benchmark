...
The file true_upper_UtoT.fa is the same thing, but the sequences were made upper case and U->T.  Like so:

cat original-true.fa | sed "s/[Uu]/t/g" | awk 'BEGIN{FS=" "}{if(!/>/){print toupper($0)}else{print $1 " " $2}}' > true_upper_UtoT.fa
